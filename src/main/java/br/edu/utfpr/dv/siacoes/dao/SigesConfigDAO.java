...
public class SigesConfigDAO implements INegocio<SigesConfig>{
    ...
    @Override
    public void getStringSQLloadObject(ResultSet rs) {
        ...
        try {
            ...
            Logger.getLogger(SigesConfigDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
